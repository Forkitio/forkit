...
const syncAndSeed = () => {
  ...
  return conn.sync({ force: true })
    ...
    Recipe.create({
      title: 'Babaganoush',
      directions: '1. Preheat oven to 450 degrees F. 2. Prick eggplant with a fork and place on a cookie sheet lined with foil. 3. Bake the eggplant until it is soft inside, about 20 minutes. Alternatively, grill the eggplant over a gas grill, rotating it around until the skin is completely charred, about 10 minutes. 4. Let the eggplant cool. Cut the eggplant in half lengthwise, drain off the liquid, and scoop the pulp into a food processor. 5. Process the eggplant until smooth and transfer to a medium bowl. 6. On a cutting board, work garlic and 1/4 teaspoon salt together with the flat side of a knife, until it forms a paste. 7. Add the garlic-salt mixture to the eggplant. 8. Stir in the parsley, tahini, and lemon juice. 9. Season with more salt, to taste. 10. Garnish with additional parsley.',
    ...
    Recipe.create({
      ...
      directions: '1. In a large bowl combine coriander, allspice, cinnamon, cumin, ginger, turmeric cayenne, pepper, salt, lemon juice, olive oil, and garlic. 2. Add chicken and toss to coat. 3. Place in a large zip-top bag and refrigerate for at least 1 hour and as long as overnight. 4. Preheat oven to 425· F. 5. Line a large baking tray with aluminum foil. 6. Place chicken in one layer on prepared tray. 7. Bake until golden brown, crispy around the edges, and no longer pink in the middle, about 20 to 25 minutes. 8. Let chicken rest for 10 minutes. 9. Slice chicken into thin pieces. 10. For extra crispy chicken, heat the last tablespoon of olive oil in a large frying pan. Crisp chicken in pan, stirring often, until golden brown and crispy, about 4 to 5 minutes. 11. Serve chicken shawarma in pita topped with sliced red onion, chopped parsley, shredded cabbage, pickled turnips, and tahini.',
    ...
    Recipe.create({
      ...
      directions: '1. In a food processor, pulse the chile and ginger until very finely chopped. 2. Add the canned tomatoes with their juice and process until the mixture is puréed. 3. Set aside and melt six (6) Tbs. of the butter in a 6-8 quart Dutch oven over medium heat. 4. When the foam subsides, add about a third of the chicken pieces and cook, stirring frequently, until the chicken absorbs some of the butter and begins to brown, 3 to 4 minutes. 5. With a slotted spoon, transfer the chicken to a plate. 6. Repeat with the remaining two batches of chicken. 7. Add the remaining 2 Tbs. butter to the pan. 8. When it’s melted, add the paprika and 4 tsp. of the cumin and stir until the spices just begin to darken, 10 to 15 seconds. 9. Immediately add the tomato mixture. Simmer vigorously, uncovered, stirring frequently, until the sauce has thickened slightly, 6 to 8 minutes. 10. Add the cream and 1 tsp. kosher salt and stir well. Add the chicken and stir gently to mix. 11. Reduce the heat to medium low and simmer, uncovered, stirring occassionally, for 10 minutes. 12. Stir in the garam masala and remaining cumin. 13. Remove from the heat, cover, and allow to rest for 15 minutes. 14. Taste and add more salt if necessary. 15. Transfer to a serving bowl, garnish with cilantro, and serve.',
