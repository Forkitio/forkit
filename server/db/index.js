  ...
  return conn.sync({ force: true })
    ...
    .then((users) => {
      ...
      return Promise.all([
        Recipe.create({
          title: 'Tabbouleh',
          directions: 'Rinse the bulgur in several changes of cold water. Drain well and put in a bowl. Stir it with a fork every now and then to help it fluff up - Put the diced tomatoes in a bowl and set aside while you prepare the herbs. A word of warning: do not chop the herbs with a mezzaluna. This will only bruise them. - Using a razor-sharp knife, grab as much of the parsley and mint as you can handle in a bunch, and slice them very thin, to end up with nice, crisp slender strips - Drain the tomatoes of their juice and put in a large bowl. - Add the spring onion and herbs. - Sprinkle the bulgur all over. - Season with the cinnamon, allspice and pepper. - Add salt to taste. - Add the lemon juice and olive oil and mix well. - Taste and adjust the seasonings if necessary. - Serve immediately with the quartered gem lettuce.',
    ...
    Recipe.create({
      ...
      directions: 'Start by making the dressing. Combine the oil, sesame oil, pineapple juice, garlic, red pepper flakes, soy sauce, fresh pineapple, ginger, and salt in a blender or food processor. Puree until smooth. - Transfer to a small saucepan, and gently warm just before serving, do not simmer or boil. - In an extra-large bowl toss the mizuna with a generous splash of the dressing. - Arrange it on a platter (as a bed for the rice). - You can serve the rice portion of this recipe room temperature or hot. - In the same bowl you used to toss the greens, or in an extra large skillet over medium heat, combine the rice, most of the onions, shallots, cashews and serrano chile, and seitan. - Add about half of the dressing and toss well. - If you are serving the rice hot, saute it in the pan until it is heated throughout. - Taste, and adjust with more dressing if needed. - Spoon the rice over the greens and finish with any remaining onions, shallots, cashews, and seitan.',
    ...
    Recipe.create({
      ...
      directions: 'To prepare rice, cook rice according to package directions, omitting salt and fat. - Drain then place rice in a large bowl. - Melt butter in a nonstick skillet over medium-high heat. - Add pineapple then sauté for 4 minutes or just until pineapple begins to brown. - Add pineapple mixture, cilantro, and 1/4 teaspoon salt to rice in bowl. - Place cover to keep warm. - Wipe pan clean with paper towels.',
    ...
    Recipe.create({
      ...
      directions: 'Preheat oven to 450 degrees Fahrenheit. - Prick eggplant with a fork and place on a cookie sheet lined with foil. - Bake the eggplant until it is soft inside, about 20 minutes. - Alternatively, grill the eggplant over a gas grill, rotating it around until the skin is completely charred, about 10 minutes. - Let the eggplant cool. - Cut the eggplant in half lengthwise, drain off the liquid, and scoop the pulp into a food processor. - Process the eggplant until smooth and transfer to a medium bowl. - On a cutting board, work garlic and 1/4 teaspoon salt together with the flat side of a knife, until it forms a paste. - Add the garlic-salt mixture to the eggplant. - Stir in the parsley, tahini, and lemon juice. Season with more salt, to taste. - Garnish with additional parsley.',
      ingredients: ['2 teaspoons coriander, 1 teaspoon allspice', '1 teaspoon cumin', '1 teaspoon ground ginger', '1 teaspoon turmeric', '1/2 teaspoon cinnamon', '1/2 teaspoon cayenne',
        '1/2 teaspoon pepper', '1 teaspoon salt', '3 tablespoons lemon juice', '2 tablespoons olive oil', 'plus 1 tablespoon for crisping on the stove', '2 garlic cloves minced', '2 pounds boneless', 'skinless chicken thighs', '6 pita', '1 red onion'],
      time: 45,
      serving: 6,
